...
<head>
    ...
    <link rel="alternate" hreflang="en" href="<?php echo $protocol.'://'.$_SERVER["HTTP_HOST"].HOST.'en'.$canonical_link; ?>" />
...
<body>
    ...
    <div id="pagina">
        ...
        <div id="logo">
            <!-- <img src="images/logo.png?v=<?php echo $version; ?>" style="width:100%; max-width:900px;"> -->
            <span class="logo logo1">h@ck</span><span class="logo logo2">web</span>
        </div>

        <!-- <div id="menu-mobile">menu'</div> -->
        <!-- <div id="struttura-fixed"></div> -->
        ...
        <div id="struttura">
            ...
            <!-- colonna destra -->
            <div class="col-dx">
                <div class="logincell">visitatore</div>
                <div class="table-dx">
                    <div class="details">
                        <?php
